...
## 4. new incog with search engines    ---------- PC
## 5. by me a coffee page
...
<!-- ## 9. bug: when there are lots of tabs, not able to scroll down to open the bottom tab. (suggestion: add scrolling and the tab widget screen be 100% the height of the webview area ig. ) -->
...
<!-- ## 18. make contact us page. help & feedback page -->
...
## 26. ADBLOCKER
## 27. ASL
## 28. BRAILLE KEYBOARD Support?
## 29. TERRATABS - V2.0
## 30. New Download Page        ---------- PC
## 31. New Contact Us Page      ---------- PC
## 32. New Passwords Manager    ---------- PC
## 33. Patent
## 34. New Domain

when it opens and closes do so with a smoooth animation.

so the history, open tabs, bookmarks, etc.. all those things should be still ther after the app is restarted.

4.the popup notifications like the ones taht come up when bookmarks are added . should look better. its just a white rectangle with text. style it better.

in the url bar, when someone searches queries instead of urls it detects that and searches in google, instead make it so taht it searches taht query in teh current selected search engines.
